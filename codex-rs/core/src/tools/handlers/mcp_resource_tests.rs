...
#[tokio::test]
async fn mcp_resource_pre_tool_use_payload_emits_canonical_tool_name() {
    ...
    assert_eq!(
        McpResourceHandler.pre_tool_use_payload(&invocation),
...
#[tokio::test]
async fn mcp_resource_pre_tool_use_payload_handles_read_resource() {
...
async fn mcp_resource_pre_tool_use_payload_skips_non_function_payloads() {
    ...
    assert_eq!(McpResourceHandler.pre_tool_use_payload(&invocation), None,);
}
